...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Hegazy GTM OS 2026" },
      { name: "description", content: "Executive Growth & Revenue Operating System for Hegazy Aluminium Group." },
      { property: "og:title", content: "Hegazy GTM OS 2026" },
      { name: "twitter:title", content: "Hegazy GTM OS 2026" },
      { property: "og:description", content: "Executive Growth & Revenue Operating System for Hegazy Aluminium Group." },
      { name: "twitter:description", content: "Executive Growth & Revenue Operating System for Hegazy Aluminium Group." },
