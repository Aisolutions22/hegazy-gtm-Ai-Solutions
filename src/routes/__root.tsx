...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Hegazy Aluminium Group's executive Go-To-Market operating system: pipeline, opportunities, accounts, and revenue execution in one workspace." },
      { name: "twitter:description", content: "Hegazy Aluminium Group's executive Go-To-Market operating system: pipeline, opportunities, accounts, and revenue execution in one workspace." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/KtqGVkh2ZOQmeKb7IKlh7rKzoS92/social-images/social-1782701982380-41575.webp" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/KtqGVkh2ZOQmeKb7IKlh7rKzoS92/social-images/social-1782701982380-41575.webp" },
